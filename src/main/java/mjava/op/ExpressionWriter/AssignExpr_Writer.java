...
public class AssignExpr_Writer extends TraditionalMutantCodeWriter {
    AssignExpr original;
    Node mutant;

    public AssignExpr_Writer(String file_name, PrintWriter out) {
        super(file_name, out);
    }
     ...
     */
    public void setMutant(AssignExpr exp1, Node exp2) {
        original = exp1;
        mutant = exp2;
    }
